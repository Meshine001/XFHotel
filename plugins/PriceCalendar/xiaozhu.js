...
function loadNyroModal()
{
 ...
 var XZWebUrlWriter = {
    ...
    getWeb_FangKe_EditUserTenantAfterOverseaUrl : function (tenantId,realName,mobile,sex,birth,oversea,nation,mobileNation,IDCardNo,passportNo) {
        return 'http://'+domain+'/xzweb.php?op=FangKe_UpdateUserTenantAfterOversea&tenantId=' + tenantId + '&realName=' + realName + '&mobile=' + mobile + '&sex=' + sex + '&birth=' + birth + '&oversea=' + oversea + '&nation=' + nation + '&mobileNation=' + mobileNation + '&IDCardNo=' + IDCardNo + '&passportNo=' + passportNo + '&random=' +new Date().getTime();
    },
    ...
    getFangDong_CleanServiceAddOrder_step2Url : function(luId) {
        return 'http://'+domain+'/xzweb.php?op=FangDong_CleanServiceAddOrder_step2&luId='+luId; 
    },
    getFangDong_CleanServiceOrderDetailRefreshState : function(orderId,lastState) {
        return 'http://'+domain+'/xzweb.php?op=FangDong_CleanServiceOrderDetailRefreshState&lastState='+lastState+'&orderId='+orderId;
    },
    getFangDong_IsCanClean : function (){
        return 'http://'+domain+'/xzweb.php?op=FangDong_CleanServiceOrderGetIsCanClean';
    },
    ...
    getAjax_CheckMobileExist : function (mobile,nationName,nationCode) {
        return 'http://'+domain+'/ajax.php?op=AJAX_CheckMobileExist&mobile=' + mobile + '&nationName=' +nationName+ '&nationCode=' +nationCode ;
    },
    ...
    getAjax_SendActivateCode : function (mobile, nationName, nationCode, verifyCode) {
        return 'http://'+domain+'/limajax/AJAX_SendActivateCode?mobile='+ mobile 
            +'&nationName=' + nationName + '&nationCode=' + nationCode +'&verifycode='+ verifyCode + '&rand='+new Date().getTime();
    },
    getAjax_SendAmendPassCode : function (mobile, verifyCode,nationName,nationCode) {
        return 'http://'+domain+'/limajax/AJAX_SendAmendPassCode?mobile='+ mobile +'&verifycode='+ verifyCode +'&nationName=' + nationName +'&nationCode='+nationCode+ '&rand='+new Date().getTime();
    },
    getAjax_CheckActiveCode : function (mobile,nationName,nationCode,activateCode) {
        return 'http://'+domain+'/ajax.php?op=AJAX_CheckActivateCode&mobile='+mobile +'&nationName='+ nationName +'&nationCode=' + nationCode +'&activatecode='+activateCode +'&rand='+new Date().getTime();
    },
    ...
    getAjax_SendConfirmCode : function (mobile, verifyCode,nationName,nationCode) {
        return 'http://'+domain+'/ajax.php?op=AJAX_SendConfirmCode&mobile='+ mobile +'&verifycode='+ verifyCode 
    ...
    getAjax_SendQuickLoginCode : function(mobile, verifyCode,nationName,nationCode){
        return 'http://'+domain+'/ajax.php?op=AJAX_SendQuickLoginCode&mobile='+ mobile +'&verifycode='+ verifyCode +  '&nationName=' +nationName +'&nationCode=' + nationCode + '&rand='+new Date().getTime();
    },
    getAjax_CheckConfirmCode : function (mobile,confirmCode,nationName,nationCode) {
        return 'http://'+domain+'/ajax.php?op=AJAX_CheckConfirmCode&mobile='+mobile+'&confirmcode='+confirmCode 
            +'&nationName='+ nationName + '&nationCode='+ nationCode +'&rand='+new Date().getTime();
    },
    ...
    getAjax_SmsCheckCodeSendUrl : function (phonenum,nationName,nationCode,imagecode,aisle) {
        return 'http://'+domain+'/ajax.php?op=AJAX_SmsCheckCodeSend&phone='+phonenum+ '&nationName=' + nationName + '&nationCode=' +nationCode+'&checkcode='+imagecode+'&aisle='+aisle;
    },
    getAjax_SetUserPhoneCodeUrl : function (phonenum,phonecode,nationName,nationCode) {
        return 'http://'+domain+'/ajax.php?op=Ajax_SetUserPhoneCode&phone='+phonenum+'&phonecode='+phonecode+'&nationName='+nationName+'&nationCode='+nationCode;
    },
    getAjax_SmsCheckCodeVerifyUrl : function (phonenum,phonecode,nationName,nationCode) {
        return 'http://'+domain+'/ajax.php?op=AJAX_SmsCheckCodeVerify&phone='+phonenum+'&phonecode='+phonecode+'&nationName='+nationName+'&nationCode='+nationCode;
    },
    ...
    getAjax_FangKe_RejectCashPledgeUrl : function (bookOrderId,version) {
        return 'http://'+domain+'/ajax.php?op=Ajax_FangKe_RejectCashPledge&bookOrderId='+bookOrderId+'&version='+version+'&rand='+new Date().getTime();
    },
    getAjax_FangKe_ConfirmCashPledgeUrl : function (bookOrderId,version) {
        return 'http://'+domain+'/ajax.php?op=Ajax_FangKe_ConfirmCashPledge&bookOrderId='+bookOrderId+'&version='+version+'&rand='+new Date().getTime();
    },
    getAjax_FangKe_ServiceCashPledgeUrl : function (bookOrderId,version) {
        return 'http://'+domain+'/ajax.php?op=Ajax_FangKe_ServiceCashPledge&bookOrderId='+bookOrderId+'&version='+version+'&rand='+new Date().getTime();
    },
    getAjax_FangKe_PayCashPledgeUrl : function (bookOrderId,payType,version) {
        return 'http://'+domain+'/ajax.php?op=Ajax_FangKe_PayCashPledge&bookOrderId='+bookOrderId+'&payType='+payType+'&version='+version+'&rand='+new Date().getTime();
    },
    ...
    getAJAX_getSettlementListUrl : function(){
        return 'http://'+domain+'/ajax.php?op=Ajax_getSettlementList';
    },
    getAJAX_getSettlementMonthAccountListUrl : function(){
        return 'http://'+domain+'/ajax.php?op=Ajax_getSettlmentMonthAccount';
    },
    getAjax_createSettlementAccountUrl : function(){
        return 'http://'+domain+'/ajax.php?op=Ajax_createSettlementAccount';
    },
    getAjax_delSettlementAccountUrl : function(){
        return 'http://'+domain+'/ajax.php?op=Ajax_delSettlementAccount';
    },
    ...
    getAjax_SetDefaultUserPaymentUrl : function (id) {
        return 'http://'+domain+'/ajax.php?op=Ajax_SetDefaultUserPayment&id='+id+'&rand='+Math.random();
    },
    ...
    getPub_CheckAddressUrl : function(provinceId,longitude,latitude){
        return 'http://'+domain+'/ajax.php?op=Ajax_Pub_CheckAddress&provinceId='+provinceId+'&longitude='+longitude+'&latitude='+latitude+'&rand='+Math.random();
    },
    ...
    getAddBillUrl : function(id){
        return 'http://'+domain+'/ajax.php?op=Ajax_FK_AddBill&invoiceId='+id+'&rand='+Math.random();
    },
    getBillUrl : function(state,id){
        ...
        return 'http://'+domain+'/xzweb.php?op=FK_AddBill'+url;
    },
    ...
    getAjaxApplyCashPledgeByLandlordUrl : function(bookOrderId,pledge2Landlord,reason){
       return 'http://'+domain+'/ajax.php?op=Ajax_FD_ApplyCashPledge';
    },
    getAjaxCancelCashPledgeByLandlordUrl : function(bookOrderId,version){
       return 'http://'+domain+'/ajax.php?op=Ajax_FD_CancelCashPledge&bookOrderId='+bookOrderId+'&version='+version+'&rand='+new Date().getTime();
    },
    getAjaxApplyServiceByLandlordUrl : function(bookOrderId,version){
       return 'http://'+domain+'/ajax.php?op=Ajax_FD_ApplyService4CashPledge&bookOrderId='+bookOrderId+'&version='+version+'&rand='+new Date().getTime();
    },
    getReturnCashPledgeUrl : function(bookOrderId,version){
       return 'http://'+domain+'/ajax.php?op=Ajax_FD_ReturnCashPledge&bookOrderId='+bookOrderId+'&version='+version+'&rand='+new Date().getTime();
    },
    ...
    getAJAXA_getServiceTimeByDate : function(date){
        return 'http://'+domain+'/xzweb.php?op=Ajax_getServiceTimeByDate&date='+date+'&rand='+new Date().getTime();
    },
    getAjax_submitCleanServiceOrder : function(){
        return 'http://'+domain+'/xzweb.php?op=Ajax_submitCleanServiceOrder';
    },
    getCleanServiceOrderDetailUrl : function(orderId){
        return 'http://'+domain+'/xzweb.php?op=FangDong_CleanServiceOrderDetail&orderId='+orderId;
    },
    getAjax_cleanServiceOrderPaySubmit : function(orderId,bank) {
        return 'http://'+domain+'/xzweb.php?op=FangDong_CleanServiceOrderPaySubmit&orderId='+orderId+'&bank='+bank;
    },
    getAjax_cancelCleanServiceOrder : function(orderId,cancelType,returnMoney,punishMoney){
        return 'http://'+domain+'/xzweb.php?op=FangDong_CleanServiceOrderCancelSubmit&orderId='+orderId+'&returnMoney='+returnMoney+'&punishMoney='+punishMoney+'&cancelType='+cancelType+'&rand='+new Date().getTime();
    },
    getFangDong_MyRoomsUrl : function(){
        return 'http://'+domain+'/xzweb.php?op=FangDong_MyRooms';
    },
    getAjax_sendCouponUrl: function (mobile,verifycode,state) {
        return "http://"+domain+"/ajax.php?op=Ajax_sendCoupon&mobile="+mobile + "&verifycode=" + verifycode + "&state=" +state;
    },
    getBookOrderSubmitUrl: function () {
        return 'http://'+domain+'/xzweb.php?op=Front_AddBookorderSubmit';
    },
    getAjax_nationCodeHtml: function () {
        return "http://"+domain+"/xzweb.php?op=GetNationCodeHtml";
    },
    getAjax_CheckTenantMobile: function (tenantId,mobile,mobileNation) {
        return "http://"+domain+"/ajax.php?op=Ajax_CheckTenantMobile&tenantId="+tenantId+"&tenantMobile="+mobile+"&mobileNation="+mobileNation;
    },
    getAjax_checkEmailValiCodeUrl: function () {
        return "http://"+domain+"/ajax.php?op=Ajax_Front_ValidateRegEmail";
    },
    getAjax_checkFindPwdEmailValiCodeUrl: function () {
        return "http://"+domain+"/ajax.php?op=Ajax_Front_ValidateFindPwdEmail";
    },
    getAjax_checkActiveEmailValiCodeUrl: function () {
        return "http://"+domain+"/ajax.php?op=Ajax_Front_ValidateActiveEmail";
    },
    get_SetUserInfoSubUrl : function() { 
        return 'http://'+domain+'/xzweb.php?op=SetUserInfoSubByType';
    },
    getWeb_GetProvinceUrl : function (nationId) { 
        return 'http://'+domain+'/xzweb.php?op=Pub_SelProvinceJson&nationid=' + nationId ; 
    },
};
 
 var xzRegularExpression={a:1,isNum:/^\d{1,}$/,isMobile:/^\d{11}$/,isUsername:/^[\w|\u4E00-\u9FA5|\u3400-\u4DB5|\uE815-\uE864|\u9FA6-\u9FBB]*$/,isChinese:/^[\u4E00-\u9FA5|\u3400-\u4DB5|\uE815-\uE864|\u9FA6-\u9FBB]+$/,simpleMobile:/^\d{11}$/,mobile:/^1((3[0-9])|(4[0-9])|(5[0-9])|(7[123456780])|(8[0-9]))\d{8}$/,password:/^[0-9a-zA-Z*!@.\-? : ;|$#%^&()_+=\[\]\\\/{}<>",~`']{0,}$/,numbers:/[1-9][0-9]{4}/,simpleEmail:/^.*?@.+$/,email:/^[a-zA-Z0-9_\.\-]+@[a-zA-Z0-9_\-]+(\.[a-zA-Z0-9_\-]+)+[a-zA-Z]+$/,passport:/^[\d\w]{4,20}$/}; 
...
$('#zminfo_pair').click(function(){
    ...
    $.ajax({
         ...
         async:false,
         datatype:'json',
         data: "op=Ajax_GetZminfo_Pair&applyUserId="+applyUserId+"&ownerUserId="+ownerUserId+"&rand="+new Date().getTime(),
         success: function(data) {
            var dataObj=eval("("+data+")");
...
function getComment(pageNo)
{
    ...
    $.ajax({
        type: "get",
        url: "/ajax.php",
        data: "op=Ajax_GetDetailComment&lodgeId="+lodgeId+"&cityDomain="+cityDomain+"&p="+pageNo,
        success: function(data) {
        if(data)
        {
...
function getOtherComment(pageNo)
{
    ...
    $.ajax({
        type: "get",
        url: "/ajax.php",
        data: "op=Ajax_GetOtherDetailComment&lodgeId="+lodgeId+"&p="+pageNo,
        success: function(data) {
        if(data)
        {
...
function calTotalPrice()
{
    ...
    if(startDate != 'yyyy-mm-dd' && startDate != '入住日期' && startDate != '' && endDate != 'yyyy-mm-dd' && endDate != '退房日期' && endDate != '')
    {
        ...
        $.ajax({
            type: "get",
            url: "/ajax.php",
            data: "op=Ajax_getTotalPrice&lodgeId="+lodgeId+"&sameRoomNum="+sameRoomNum+"&startdate="+startDate+"&enddate="+endDate+"&rand="+rand,
            success: handleUpdatePriceArea
        });
        //getCancelRule(lodgeId,startDate,endDate,sameRoomNum);
    }
    //}}}
}
...
function clearDetialCalendar()
{
    ...
    $.ajax({
        type: "get",
        url: "/ajax.php",
        data: "op=Ajax_initPriceArea&lodgeId="+lodgeId+"&rand="+rand,
        success: handleUpdatePriceArea
    });
    //}}}
}

function handleUpdatePriceArea(data)
{
    //{{{
    if(data)
    {
...
function getCancelRule(lodgeId,startDate,endDate,sameRoomNum)
{
    ...
    $.ajax({
        ...
        url: "/ajax.php",
        async:false,
        data: "op=AJAX_GetCancelRule4Detail&luid="+lodgeId+"&roomnum="+sameRoomNum+"&startdate="+startDate+"&enddate="+endDate+"&rand="+new Date().getTime(),
        success: function(data) {
            var dataObj=eval("("+data+")");
            if(dataObj['error'] == '1')
            {
...
function getRoomBookAbleAndBook(lodgeId,sameRoomNum,startDate,endDate)
{
    ...
    $.ajax({
        ...
        async:false,
        dataType:'json',
        data: "op=Ajax_GetRoomBookAble&lodgeId="+lodgeId+"&sameRoomNum="+sameRoomNum+"&startdate="+startDate+"&enddate="+endDate+"&rand="+new Date().getTime(),
        success: function(data) {
            var dataObj=data;
            if(dataObj['error'] == '1')
            {
                ...
                var bookParams = 'luid='+lodgeId+'&roomNum='+parseInt(sameRoomNum)+'&checkinDay='+startDate+'&checkoutDay='+endDate;
                if($('#filterKey').val() !='')
...
window.DetailPageApp = {
        ...
        $(window).scroll(function() {
            ...
            if(diaryNum && diaryNum != '0') {
                if(scrollTop >= detailImageBox.offset().top) {
                    ...
                    $('#floatRightBox').css({'position':'fixed','top':hearderHeight,'left':left,'z-index':'998'});
                } else {
    ...
    initDetailShare : function(){
        //{{{
        $('.detail-default-share').mouseenter(function(){
            $('.detail-icon-share').show(); 
            $('.collection_ul:visible').find('.collection_btn_short').show().end().find('.collection_btn_full').hide();
            $('.detail-default-share').hide();
        }); 
        $('.detail-icon-share').mouseleave(function(){
            $('.detail-icon-share').hide(); 
            $('.collection_ul:visible').find('.collection_btn_short').hide().end().find('.collection_btn_full').show();
            $('.detail-default-share').show();
        });
        
        $('#sharetool_weixin').hover(
            function(){
                $(this).closest('li').find('.weixin_code').show();
            },
            function(){
                var that = this;
                setTimeout(function(){
                    var weixinBox = $(that).closest('li').find('.weixin_code');
                    if(weixinBox.attr('show') != 1){
                       weixinBox.hide();
                    }
                },200);
            }
        );
        $('.detail-icon-share .weixin_code').hover(
            function(){
                $(this).show().attr('show',1);
            },
            function(){
                $(this).hide().attr('show',0);
            }
        );
        //}}}
    },
    ...
    collectionRoom : function(){
        //{{{
        var loginUserid=$('#loginUserId').val();
        var lodgeUnitId=$('#lodgeUnitId').val();
        var data =  XZWebUrlWriter.getRequest(XZWebUrlWriter.getAjaxAddFavorite(loginUserid,lodgeUnitId),'json');
        if(data.status==1 && typeof data.status =='number'){
            if(data.sucmsg=='del'){
                $('#collectionBtn').closest('ul').show();
                $('#unCollectionBtn').closest('ul').hide();
            }else if(data.sucmsg=='add'){
...
window.DetailGMap = {
    ...
    loadJScript : function(){
        ...
        //script.src = 'https://maps.google.cn/maps/api/js?key='+mapKey+'&callback=DetailGMap.initMap';
        //document.body.appendChild(script);       
        script = '<script src="http://maps.google.cn/maps/api/js?key=AIzaSyDQgE7zkdkcCxvl92wQAMBeTiM1Aa8z8NY&callback=DetailGMap.initMap&libraries=places" async defer></script>';
        $('body').append(script);       
        //}}}
    },
    initMap : function () {
        ...
        marker = new google.maps.Marker({
            position: myLatlng,
            map: DetailGMap.GMap,
            icon: 'http://'+topLevelDomain+'/images/detail/icon_room.png'
        });
    },
...
window.DetailBMap = {
    ...
    loadJScript : function(){
        ...
        var script = document.createElement("script");
        script.type = "text/javascript";
        script.src = "http://api.map.baidu.com/api?v=2.0&ak="+mapKey+"&callback=DetailBMap.initMap";
        document.body.appendChild(script);       
        //}}}
    },
    initMap : function(){
        ...
        var icon = new BMap.Icon('http://'+topLevelDomain+'/images/detail/icon_room.png', new BMap.Size(40, 50));
            ...
            onSearchComplete: function(results){
                ...
                if (local.getStatus() == BMAP_STATUS_SUCCESS){
                    ...
                    for (var i = 0; i < datas.length; i ++){
                        var data = datas[i];
                        var icon = new BMap.Icon('http://'+topLevelDomain+'/images/detail/'+data.iconTag.def, new BMap.Size(40, 50));
                            icon.setImageSize(new BMap.Size(40, 50));
    ...
    addMarkerAddEventListener : function(marker){
        marker.addEventListener("mouseover", function (e) {
            ...
            var icon = new BMap.Icon('http://'+topLevelDomain+'/images/detail/'+DetailBMap.pointArrays[key].icon.act, new BMap.Size(40, 50));
                icon.setImageSize(new BMap.Size(40, 50));
            this.setIcon(icon);
        ...
        marker.addEventListener("mouseout", function (e) {
            ...
            var key = e.currentTarget.ba;
            var icon = new BMap.Icon('http://'+topLevelDomain+'/images/detail/'+DetailBMap.pointArrays[key].icon.def, new BMap.Size(40, 50));
                icon.setImageSize(new BMap.Size(40, 50));
            this.setIcon(icon);
            //this.setTop(false);
            $('#label_'+key).hide()
...
$(function(){
    ...
    if(luid){
        $.ajax({
            type: "GET",
            url:  "/ajax.php?op=Ajax_GetSameRooms&luid="+luid,
            success: function(data){
    ...
    $('.contact-customer-service').click(function(e){
        if($('#loginUserId').length != 0){
            e.preventDefault();
            xzweb.ui.alert('请拔打 400-018-3100 联系客服');
        }
    });
 ...
 var LodgeUnitCalendarImageCodeValidator = {
    ...
    showImageCodeBox : function()
    {
        ...
        '<div style="width:400px; height:218px; border-radius:3px; background:#fff; position:fixed; z-index:6668; left:50%; top:50%; margin-top:-109px; margin-left:-200px; font:normal 16px/30px Microsoft YaHei;">',
            '<div class="validate_closed" style="position:absolute; top:17px; right:17px; cursor:pointer; background:url(/images/detail/yz_closed.png) no-repeat; width:16px; height:17px;"></div>',
            '<h4 style=" height:50px; line-height:50px; background:#f6f6f6; font-size:16px; font-weight:bold; padding-left:20px; color:#959ea7;">请输入验证码</h4>',
            '<div style="padding:59px 0 0 53px;">',
                ...
                '<span style="display:inline-block; width:70px; height:38px; border:1px solid #ddd; margin-left:5px;vertical-align:top;"><img style="width:68px;height:36px;" src="/ajax.php?op=AJAX_PicCheckCodeShow&nocache='+noCache+'" alt=""></span>',
            '</div>',
        '</div>'].join('');

        var validBox = $(imageCodeBox).appendTo($('body'));
        $('body').css('overflow','hidden');
        validBox.find('.validate_closed').click(function(){
            validBox.hide();
            $('body').css('overflow','visible');
        });
        validBox.find('.validate_input').keyup(function(e){
            ...
            if(verifyCode.length>3){
                ...
                if(data){
                    ...
                    $(this).val('')
                    validBox.find('img').click();             
                }
            }
        });
        validBox.find('.validate_input').focus(function(e){
            $(this).css('border','1px solid #2c3e50');  
        });
        validBox.find('img').click(function(){
