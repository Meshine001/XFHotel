...
<body>
	...
	<div class="row clearfix" style="margin-top: 50px">
		<div class="col-md-12 column">
			<ul class="breadcrumb">
				<li>青舍首页</li>
					<li class="active">查找公寓</li>
				<li class="active" id="search-type" style="display: none;">${sessionScope.searchType}</li>
			</ul>
				...
				<div class="col-md-12 column">
					<ul>
						...
						<li><label>类型:</label><span
							...
							class="label label-info lease-type" id="1">酒店式</span> <span
							class="label label-info lease-type" id="2">休闲式</span></li>
