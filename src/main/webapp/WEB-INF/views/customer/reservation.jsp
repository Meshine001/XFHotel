...
<body class="po_r">
	...
	<script language="javascript">
		...
		var As = $('#nav_ul').children('li');
		obj = As.eq(0);
		if (strVariable.indexOf("/list/") > 0
				|| strVariable.indexOf("/duibi.html") > 0
				|| strVariable.indexOf("com/info-") > 0
				|| strVariable.indexOf("/dibiao/") > 0) {
			obj = As.eq(1);
		} else if (strVariable.indexOf("/maplist/") > 0) {
			obj = As.eq(2);
		} else if (strVariable.indexOf("/gushi") > 0
				|| strVariable.indexOf("/kuaixun") > 0
				|| strVariable.indexOf("/shenghuo") > 0
				|| strVariable.indexOf("gushi/info-") > 0
				|| strVariable.indexOf("kuaixun/info-") > 0
				|| strVariable.indexOf("shenghuo/info-") > 0) {
			obj = As.eq(3);
		} else if (strVariable.indexOf("/qcgy.html") > 0) {
			obj = As.eq(4);
		} else if (strVariable.indexOf("/gongyu.html") > 0) {
			obj = As.eq(5);
		} else {
			obj = As.eq(0);
		}
	...
	<article>
			...
			<div class="e_my">
				<script type="text/javascript">
					$(document).ready(function() {
						$("#wodeyuyue").click(function() {
							location.href = '/home/yuyue.html';
						})
						$("#wodegongyu").click(function() {
							location.href = '/home/gongyu.html';
						})
						$("#jiaofei").click(function() {
							location.href = '/home/jiaofei.html';
						})
						$("#wodeshoucang").click(function() {
							location.href = '/home/shoucang.html';
						})
						$("#wodetousu").click(function() {
							location.href = '/home/tousu.html';
						})
						$("#gerenziliao").click(function() {
							location.href = '/home/ziliao.html';
						})
						$("#zhanghaoshezhi").click(function() {
							location.href = '/home/shezhi.html';
						})
						$("#youhuiquan").click(function() {
							location.href = '/home/youhuiquan.html';
						})
						$("#tuiguang").click(function() {
							location.href = '/home/tuiguang.html';
						})
		...
		<li id="jiaofei" class="">
			<p>缴费</p><i></i>
				...
				<div class="e_right">
					<div class="e_none">
						<img src="http://mf.znimg.com/public/images/none.png" width="120"
							height="120">
						<p style="display: none;">
							您尚未预约魔飞公寓，赶快去预约您喜欢的魔飞公寓吧~~<a href="/list/" title="魔飞搜公寓">魔飞搜公寓
								&gt;</a>
						</p>
					</div>
				</div>
