...
<body>
    ...
    <div class="ol_info">
      ...
      <dl>
        ...
        <dt>
          <input id="shouji" class="ol_input" value="${c.details.cusTel}" name="cusTel" placeholder="请填写您的手机号">
        </dt>
      </dl>
            <dl>
        <dd><font color="#FF0000">*</font>&nbsp;身份证号：</dd>
        <dt>
          <input id="shouji" class="ol_input" value="${c.details.cusIdCard}" name="cusIdCard" placeholder="请填写您的身份证号">
        </dt>
      </dl>
      <dl>
        <dd>需要发票：</dd>
      ...
      <input type="hidden" value="startTime" name="${oStart}">
      <input type="hidden" value="endTime" name="${oEnd}">
      ...
      <input type="hidden" name="apartmentType" value="${apartment.type}">
