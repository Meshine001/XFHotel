...
//        			window.location.href=data.panorama;
            ...
            data.basic_info.wei+"卫"+'</p>' +
                '<p class="info_L24 label-adders"><span class="czs-location-l"></span>'+vio+"-"+data.position.jie_dao+data.position.xiao_qu+'</p><span class="label-price">'+data.basic_info.jia_ge+'<small>/天</small></span><p class="info_L24" style="color: #fff;background:#e40f4a;width: 2.5rem;border-radius: 0.5rem;text-align: center;">满3天9.5折、满7天9折、满30天8折</p>'
