...
public class CustomerDetails {
	...
	public String toString() {
		return "CustomerDetails [id=" + id + ", nick=" + nick + ", sex=" + sex + ", birthday=" + birthday
				+ ", constellation=" + constellation + ", job=" + job + ", education=" + education + ", declaration="
				+ declaration + ", hobby=" + hobby + ", avatar=" + avatar + ", customer=" + customer + "]";
	}
